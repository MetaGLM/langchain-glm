from langchain_zhipuai.chat_models.all_tools_message import _paser_chunk, default_all_tool_chunk_parser
...
def test_paser_web_browser_success_tool_calls():
    ...
    print(tool_call_chunks)
    assert tool_call_chunks[0]["name"] == "web_browser"
    assert tool_call_chunks[0]["args"] == '{"outputs": [{"title": "昨夜今晨，京津冀发生这些大事（2024年6月27日） - 腾讯网", "link": "https://new.qq.com/rain/a/20240627A013AI00", "content": "网页1 天前\u2002·\u2002昨夜今晨，京津冀发生这些大事（2024年6月27日）. 北京首套房首付比例最低2成. “517”楼市新政的“靴子”在北京落地了。. 昨天，北京市住建委、中国人民银行北京市分行 … \xa0 "}]}'
    paser, invalid_tool_calls = _paser_chunk(tool_call_chunks)
    ...
    assert paser[0]["args"] == {'outputs': [{'title': '昨夜今晨，京津冀发生这些大事（2024年6月27日） - 腾讯网', 'link': 'https://new.qq.com/rain/a/20240627A013AI00', 'content': '网页1 天前\u2002·\u2002昨夜今晨，京津冀发生这些大事（2024年6月27日）. 北京首套房首付比例最低2成. “517”楼市新政的“靴子”在北京落地了。. 昨天，北京市住建委、中国人民银行北京市分行 … \xa0 '}]}
